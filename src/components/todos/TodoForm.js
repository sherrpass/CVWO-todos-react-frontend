        ...
        return this.props.category.loading ? (
            ...
            <div>
                <form onSubmit={this.onSubmit}>
                    ...
                    <button type="button" onClick={this.onImportanceChange}>
                        {this.state.todo.important
                            ? "Important"
                            : "Not Important"}
                    </button>
                    ...
                    <div>
                        ...
                        <button type="button" onClick={this.onNewCategoryClick}>
                            Add New Category
                        </button>
                        <ReactModal
                        ...
                        >
                            <CategoryForm
                                onSubmit={this.onAddFormCategorySubmit}
                                isEdit={false}
                            />
                        </ReactModal>
